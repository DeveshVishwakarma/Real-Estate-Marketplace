...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(msg.sender == _owner, 'Caller is not identified as owner');
        _;
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), 'Address provided is not a valid Ethereum address');
        _owner = newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, 'Required: Given address should not be owner of the tokenId');

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), 'Required: Message sender to be the owner of the contract or isApprovedForAll() to be true');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == tokenOwner, 'Required: From address should be the owner of the given token');

        // TODO: require token is being transfered to valid address
        require(to != address(0), 'Required: Token should be transferred to valid address');
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint tokenId) internal {
        require(_exists(tokenId), 'Required: Token exists before setting');
...
contract RealEstateERC721Token is ERC721Metadata("Devesh Vishwakarma","DV","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
