...
contract('TestSolnSquareVerifier', accounts => {
    ...
    it('1: Test if a new solution can be added for contract - SolnSquareVerifier', async function () {
    ...
    it('2: Test if an ERC721 token can be minted for contract - SolnSquareVerifier', async function () {
        let mint = true
        try {
        ...
        assert.equal(mint, true, "Failed to mint token");
    })
})
